...
void chifoumi::checkScore()
{
    ...
    if(valJ == 5)
    {
        ...
        maBox.setWindowTitle("Fin de partie");
        maBox.setText("bravo joueur! Vous gagnez avec 5 point en "+QString::number(30-tempsAffichageRestant)+" secondes");
        ChronoAfficher->stop();
        chrono->stop();
        maBox.exec();
        lancerPartie();
    ...
    else if(valM == 5)
    {
        ...
        maBox.setIcon(QMessageBox::Information);
        maBox.setWindowTitle("Fin de partie");
        maBox.setText("bravo machine! Vous gagnez avec 5 point en "+QString::number(30-tempsAffichageRestant)+" secondes");
        ChronoAfficher->stop();
        chrono->stop();
        maBox.exec();
        lancerPartie();
...
void chifoumi::affichageTimer()
{
    ...
    ui->labelTimer->setText("tps restant (s):"+ test.setNum(tempsAffichageRestant));
...
void chifoumi::lancerPartie()
{
    ...
    ui->labelTimer->setText("tps restant (s):"+ test.setNum(tempsRestant));
    ouiPause =false;
...
void chifoumi::demanderEteindre()
{
    ...
    if(valJ > valM)
    {
        QMessageBox maBox;
        maBox.setIcon(QMessageBox::Information);
        maBox.setText("le timer est terminé mais le joueur gagne quand même avec "+QString::number(valJ)+" point");
        maBox.exec();
        lancerPartie();
    }
    else if(valJ <valM)
